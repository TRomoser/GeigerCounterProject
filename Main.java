 ...
 * @date 3/22/25
 *  To determine the most likely date of the camping trip, I wrote a program that:
 ...
 * I was able to identify the most likely date I was at a higher elevation.
 * 
 * Based on this method, the most likely camping trip date was: June 1, 2019
 * But based on data you likely started the trip on May 31, 2019 and ended on 
 * June 2, 2019
 * 
 * Challenges/roadblocks:
 * - I initially was challenged by the first lines of the file, I needed to
 *  skip the ones that were shorter than 3 entries
...
public class Main {
  public static void main(String[] args) {
    ...
    // Read text file and add to sample array list, 
    ...
    // Add samples with count within 5 of maxCount to new array list
    ...
    printTable("Radiation Count by Date", maxCountSamples);
    ...
    for(RadiationSample sample: maxCountSamples) {
      ...
      // try catch because there is a line with date 2019-05-32 00:11
      try {
    ...
    printTable("Samples that day", groupedByDate.get(campDate));
  }

  public static void printTable(String title, List<RadiationSample> samples) {
    int totalWidth = 30;
